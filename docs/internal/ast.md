...
The **Abstract Syntax Tree (AST)** is a tree representation of the source code. Unlike the flat list of tokens from the Lexer, the AST shows the _structure_ and _hierarchy_ of the code.
